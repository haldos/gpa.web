...
<head>
	...
	function showFlags(){
	document.write('<td><a href="'+getCurrentFile()+'.html"><img src="./images/es_flag.png" alt="Español" width="24"/></a></td>');
	document.write('<td><a href="'+getCurrentFile()+'_en.html"><img src="./images/en_flag.png" alt="English" width="24"/></a></td>');
	}
	</script>
...
?>
	...
	<div id="sidebar">
		...
		-->
			...
			<center>
				Idioma / Language:<br>
				<table cellspacing="0" cellpadding="2" width="60" height="32" border="0" align="center"> <tbody> 
				<tr>
				<script languaje="javascript">showFlags();</script>
				</tr>
				</tbody></table>
			</center>
